...
class BookSeeder extends Seeder {
	...
	public function run()
	{
		...
		// $book1 = Book::create(array('title' => 'Book One', 'user_id' => $users[1]->id));
		// $book1->createAttributeValue('summary', 'Summary of Book One');
		// $book1->createAttributeValue('summary', 'Summary of Book One Updated');
		// $book1->createAttributeValue('summary', 'Lorem Ipsum One, Lorem Ipsum');
		// $books[] = &$book1;
		...
		// $summaryAttributeValue = new AttributeValue(array('attribute_id' => $summaryAttribute->id, 'value' => 'Summary of Book One'));
		// $book1->attributeValues()->save($summaryAttributeValue);

		// $quoteAttributeValue1 = new AttributeValue(array('attribute_id' => $quoteAttribute->id, 'value' => '"Lorem Ipsum One, Lorem Ipsum"'));
		// $book1->attributeValues()->save($summaryAttributeValue);
	}
